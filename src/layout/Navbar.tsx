            ...
            <div className="flex items-center">
              ...
              <div className="hidden md:block ml-10">
                <div className="flex items-baseline space-x-4">
                  ...
                  <a href="#resources" className="hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium transition-colors">Resources</a>
                  <a href="#pricing" className="hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium transition-colors">Pricing</a>
                </div>
              </div>
            </div>
